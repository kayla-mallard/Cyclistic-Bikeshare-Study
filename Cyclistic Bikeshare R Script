...
Divvy_Trips_2020_Q1_1_ <- read_csv("Divvy_Trips_2020_Q1.csv")
...
colnames(Divvy_Trips_2020_Q1_1_)
...
all_trips <- bind_rows(Divvy_Trips_2019_Q1, Divvy_Trips_2020_Q1_1_)
...
all_trips_v2 %>% 
  ...
  ,average_duration = mean(ride_length)) %>%								# sorts
